  ...
  return (
    ...
    >
      <HeritageCard>
        ...
        >
          An AI-assisted mobile system for quickly classifying damage levels in
      ...
      <View>
        ...
        <View style={{ gap: SPACING.element }}>
          ...
          <Card
            ...
            description="Scan or select a photo and receive an instant assessment with confidence scores and visual evidence."
          />
        </View>
      </View>
